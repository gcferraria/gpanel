    ...
    var 
        ...
        , JsB = my.Class( Base, {
            ...
            , 'attach': function ( elem, name, index ) {
                ...
                var cName = $.attr('data-jsb-context');
                if( cName ) {
                    object.contextName = cName;
                    object.context[ cName ] = object; 
                }
            ...
            , 'dettach': function ( elem ) {
                ...
                if( cName ) {
                    ...
                    object.context[ cName ] = this; 
                }

                //delete alias in context
                if( object.contextName ) {
                    delete object.context[  object.contextName ];
                }
                    ...
                    for ( var key in data ) {
                        ...
                        if ( child instanceof Function ) {
                            ...
                            if ( child instanceof JsB )
                                ...
                                this[ key ] = value;
                        else if( ! /^\$/.test( key ) ) //it's a dom node attribute
                            this.$.attr(key, value);
                    }
                }
                else {

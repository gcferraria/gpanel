<div class="portlet light" data-jsb-name="options" data-jsb-type="context" data-jsb-class="App.Portlet">
    ...
    <div class="portlet-body" data-jsb-name="body" data-jsb-class="JsB">
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
                <?php $this->load->view('html/tables/datatable.php', array( 'table' => $options->options_table ) ) ?>   
            </div>
            <div class="tab-pane" id="tab_2">
                <?php $this->load->view('html/tables/table.php', array( 'table' => $options->inherit_table ) )?>
            </div>
        </div>
    </div>
</div>

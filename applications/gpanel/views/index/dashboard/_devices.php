<div class="portlet light bordered" data-jsb-name="devices" data-jsb-type="context" data-jsb-class="App.Portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-bar-chart font-yellow"></i> 
            <span class="caption-subject font-yellow bold uppercase"><?=$this->lang->line("dashboard_box_devices_title")?></span>
        </div>
        <div class="actions">

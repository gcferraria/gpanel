...
class GP_Email extends CI_Email {
    ...
    public function __construct($config = array()) {
        ...
        if ($this->mailer_engine == 'phpmailer') {
            ...
            if (!class_exists('PHPMailer', false)) {
                require_once HOMEPATH . 'applications/common/third_party/phpmailer/PHPMailerAutoload.php';
            }
            //

            $this->phpmailer = new PHPMailer();
            $this->phpmailer->PluginDir = HOMEPATH . 'applications/common/third_party/phpmailer/';

 ...
 * @category   Form
 * @uses       CI_Form_Validation
 * @author     Gonçalo Ferraria <gferraria@gmail.com>
 * @copyright  2011 - 2014 Gonçalo Ferraria
 * @version    1.1 Form_Validation.php 2014-12-01 gferraria $
 */
...
class GP_Form_validation extends CI_Form_validation {
    ...
    **/
    public function spaces( $value ) {
        ...
        // Return TRUE if Value has spaces and FALSE if not.
...
/* End of file GP_Form_validation.php */
/* Location: ../applications/gpanel/libraries/GP_Form_validation.php */

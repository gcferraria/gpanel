...
class Administrators extends HTML_Controller {
    ...
    **/
    public function add() {
        ...
        $administrator_form
            ->builder( 'post', '/administrators/add.json' )
    ...
    **/
    public function edit() {
        ...
        $administrator = new Administrator();
        $administrator->get_by_id( $this->uri->segment(3) );
        ...
        // Build Administrator Form.
        $administrator_form
            ->builder( 'post', '/administrators/edit/' . $administrator->id . '.json')
...
/* Location: ../applications/gpanel/controllers/administrators.php */

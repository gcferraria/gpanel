...
class Content_Types extends HTML_Controller {
    ...
    **/
    public function edit() {
        ...
        $content_type = new Content_Type();
        $content_type->get_by_id( $this->uri->segment(3) );
        ...
        // Build Content Type Form.
        $content_type_form
            ->builder('post', '/content_types/edit/' . $content_type->id . '.json')
...
/* Location: ../applications/gpanel/controllers/content_types.php */

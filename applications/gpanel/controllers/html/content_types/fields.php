...
class Fields extends HTML_Controller {
    ...
    public function __construct() {
        ...
        $this->breadcrumb->add( array(
                    ...
                    array(
                        ...
                        'href' => 'content_types/fields/index/' . $this->content_type->id
                    ),
                )
            );
    }
    ...
    **/
    public function index( $id ) {
        ...
        $data = (object) array(
                'source' => 'content_types/fields/index/' . $this->content_type->id . '.json',
                'header' => array(
        ...
        $this->add_data( array(
                'table'   => $data,
                'actions' => array(
                    'Adicionar' => '/content_types/fields/add/' . $this->content_type->id,
                )
            )
        );
    ...
    **/
    public function add() {
        ...
        $content_type_field_form
            ->builder( 'post', '/content_types/fields/add/' . $this->content_type->id . '.json')
    ...
    **/
    public function edit() {
        ...
        // Build Content Type Field Form.
        $content_type_field_form
            ->builder('post', '/content_types/fields/edit/' . $this->content_type_field->id . '.json')
            ->add_fields(
...
/* Location: ../applications/gpanel/controllers/content_types/fields.php */
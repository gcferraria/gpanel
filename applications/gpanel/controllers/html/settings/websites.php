...
class Websites extends HTML_Controller {
    ...
    **/
    public function index() {
        ...
        $this->add_data( array(
                    ...
                    'actions' => array(
                        $this->lang->line('add') => 'settings/websites/add',
                    )
                )
            );
    ...
    **/
    public function add() {
        ...
        // Build Form.
        $form = new Form();
        $form->builder( 'post', '/settings/websites/save.json' )
    ...
    **/
    public function edit( $id ) {
        ...
        $website->languages = $languages;
         ...
         // Build Form.
        $form = new Form();
        $form->builder( 'post', '/settings/websites/save/' . $website->id . '.json' )
...
/* Location: ../applications/gpanel/controllers/html/settings/websites.php */

...
class Languages extends HTML_Controller {
    ...
    **/
    public function index() {
        ...
        $this->add_data( array(
                    ...
                    'actions' => array(
                        $this->lang->line('add') => 'i18n/languages/add',
                    )
                )
            );
    ...
    **/
    public function add() {
        ...
        // Build Language Form.
        $form = new Form();
        $form->builder( 'post', '/i18n/languages/save.json' )
    ...
    **/
    public function edit( $id ) {
        ...
        $this->breadcrumb->add( array(
         ...
         // Build Language Form.
        $form = new Form();
        $form->builder( 'post', '/i18n/languages/save/' . $language->id . '.json' )
...
/* Location: ../applications/gpanel/controllers/html/i18n/languages.php */

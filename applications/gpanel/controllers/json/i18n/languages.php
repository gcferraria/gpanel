        ...
        foreach ( $languages as $language ) {
            $data[] = array(
                ...
                3 => ( $language->default == 1 )
                        ...
                        : '<span class="label label-info">' . $this->lang->line('no').'</span>',
                4 => '<a href="'.site_url('/i18n/languages/edit/'. $language->id).'" class="btn btn-xs green-meadow"><i class="fa fa-edit"></i>'.
                     $this->lang->line('edit') . '</a>' .
                     '<a href="#" class="btn btn-xs red-sunglo" data-text="'. $this->lang->line('delete_record').'"',
            );
        }
...
/* Location: ./applications/gpanel/controllers/json/i18n/languages.php */
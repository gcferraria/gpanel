...
class Administrators extends JSON_Controller {
    ...
    /**
     * __construct: Ajax Administrators Class constructor.
     *
     * @access public
     * @return void
    **/
    ...
    public function index() {
        ...
        foreach ( $administrators as $administrator ) {
            $data[] = array(
                ...
                4 => '<a href="'.site_url('administrators/edit/'. $administrator->id).'" class="btn btn-xs green-meadow"><i class="fa fa-edit"></i> Editar</a>',
            );
        }
    ...
    **/
    public function add() {
        ...
        if ( $administrator->save() ) {
            ...
            $data = array(
                'reset'        => 1,
                'notification' => array( 'success', $this->lang->line('administrator_insert_success_message') ),
            );
        }
        else {
            ...
            $data = array(
                ...
                'notification' => array( 'error', $this->lang->line('administrator_insert_error_message') ),
            );
        }
    ...
    **/
    public function edit( $id ) {
        ...
        if ( $administrator->save() ) {
            $data = array(
                'show_errors'  => array(),
                'notification' => array( 'success', $this->lang->line('administrator_update_success_message') ),
            );
        }
        else {
            ...
            $data = array(
                'show_errors' => $administrator->errors->all,
                'notification' => array( 'error', $this->lang->line('administrator_update_error_message') ),
            );
        }
...
/* Location: ./applications/gpanel/controllers/json/administrators.php */
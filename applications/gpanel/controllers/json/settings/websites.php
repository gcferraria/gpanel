    ...
    public function index() {
        ...
        foreach ( $websites as $website ) {
            ...
            $data[] = array(
                ...
                0 => $website->name,
                1 => $website->domain,
                2 => '<a href="'.site_url('/categories/contents/' . $category->id ) .'">' . $category->name . '</a>',
                3 => '<a href="'.site_url('/settings/websites/edit/'. $website->id).'" class="btn btn-xs green-meadow"><i class="fa fa-edit"></i>'.
...
/* Location: ./applications/gpanel/controllers/json/settings/websites.php */